...
<header>
	...
	<nav>
		<ul>
			...
			<li class="{{ $__env->yieldContent('body_class') == 'fellow survey' ? "active" : ''}} tour_7"><a href="{{url( $linkDash .'/'.$program->slug.'/encuestas')}}" data-title="Encuestas"><b class="icon i_news"></b></a></li>
			@else
