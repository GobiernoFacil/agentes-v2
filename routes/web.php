...
Route::get('programa-gobierno-abierto/{program_slug}/ver-generacion/ver-fellow/{fellow_slug}', 'Front@viewFellow');
Route::get('programa-gobierno-abierto/{program_slug}/ver-contenido', 'Front@content');
Route::get('programa-gobierno-abierto/{program_slug}/ver-archivo/{identifier}', 'Front@watchFile');
...
Route::group(['middleware' => ['auth']], function () {
  ...
  Route::group(['middleware' => 'type:fellow' ], function(){
    ...
    Route::group(['middleware' => 'program'], function(){
        ...
        /*    Route::get('tablero/{program_slug}/aprendizaje/diagnostico/{activity_slug}/examen/responder', 'FellowDiagnostic@add');
          ...
          Route::get('tablero/{program_slug}/encuestas/{survey_slug}', 'FellowSurveys@welcome');
          Route::post('tablero/{program_slug}/encuestas/{survey_slug}/guardar-respuesta', 'FellowSurveys@saveAnswer');
          Route::get('tablero/{program_slug}/encuestas/{survey_slug}/gracias','FellowSurveys@thanks');
  ...
  //  Route::get('tablero-facilitador/foros/ver/{id}', 'FacilitatorForums@view');
    ...
    //// noticias
    Route::get('tablero-facilitador/noticias-eventos', 'NewsEventsFacilitator@index');
