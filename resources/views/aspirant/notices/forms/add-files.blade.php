...
<div class="row">
  <div class="col-sm-12">
    <p>
      ...
      {{Form::file('letter', ['class' => ''])}} (documento no mayor a 2.5 Mb, formato jpg, jpeg, png o pdf)
...
<div class="row">
  <div class="col-sm-12">
    <p>
      ...
      {{Form::file('privacy', ['class' => ''])}} (documento no mayor a 2.5 Mb, formato jpg, jpeg, png o pdf)
