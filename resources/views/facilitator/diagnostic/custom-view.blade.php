...
@section('body_class', '')
@section('breadcrumb_type', 'diagnostic custom view')
...
<div class="col-sm-12 right">
    <a href='{{ url("tablero-facilitador/diagnostico/descargar/pdf/{$questionnaire->id}")}}' class="btn xs view">Descargar PDF</a>
    <a href='{{ url("tablero-facilitador/diagnostico/descargar/xlsx/{$questionnaire->id}") }}' class="btn xs view">Descargar XLSX</a>
</div>
</div>
<div class="box">
	<div class="row">
