    ...
    <!-- answer_open -->
      <div class="col-sm-12">
        <p>
          ...
          {{Form::textarea('question_'.$count.'_'.$question->id,$aspirantInterview->get_question_data($question->id)->answer, ["class" => "form-control"])}} </label>
                                  ...
                                  <span class="row">
                                   <span class="col-sm-9">{{$question->min_label}}</span>
                                  	<span class="col-sm-3">{{$i}}<br>
          								              ...
          								              {{Form::radio('question_'.$count.'_'.$question->id."[$i]",$i, $aspirantInterview->get_question_data($question->id)->answer== $i ? true : '',['class' => 'form-control '.'question_'.$question->id])}}
                                  		</span>
                                  	</span>
                              </label>
                      @elseif($i===$question->options_columns_number)
