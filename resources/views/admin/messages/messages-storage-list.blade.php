...
<div class="row">
  ...
  <div class="col-sm-3 center">
		<a href="{{ url('dashboard/mensajes') }}" class="btn gde"> Mensajes</a>
	</div>
</div>
			...
			<table class="table">
			  ...
			  <tbody>
			    ...
			    <tr>
			        ...
			        <td><a href="{{ url('dashboard/mensajes/ver/' . $conversation->id) }}">{{$conversation->title}}</a>
...
<div class="row">
  <div class="col-sm-12">
	  <div class="box center">
	  	...
	  	<a href="{{ url('dashboard/mensajes') }}" class="btn ev"> Ir a Mensajes</a>
	  </div>
  </div>
</div>
@endif
