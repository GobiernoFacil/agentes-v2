...
<div class="map_container">
	...
	<div class="container">
			<div class="col-sm-8 col-sm-offset-2">
				<h2 class="title"><strong><a href="{{'programa-gobierno-abierto/alcance'}}">ALCANCE</a></strong> DEL PROGRAMA DE GOBIERNO ABIERTO DESDE LO LOCAL PARA EL DESARROLLO SOSTENIBLE</h2>
