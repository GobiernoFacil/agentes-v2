{!! Form::model($user,['url' => "tablero/perfil/save", "class" => "form-horizontal",'files'=>true]) !!}
...
<div class="row">
  <div class="col-sm-12">
    ...
    <p>
      ...
      {{Form::text('web', $user->fellowData->web, ["class" => "form-control"])}}
      @if($errors->has('web'))
...
<div class="row">
  <div class="col-sm-6">
    <p>
      ...
      {{Form::text('twitter', $user->fellowData->twitter, ["class" => "form-control"])}}
  ...
  <div class="col-sm-6">
    <p>
      ...
      {{Form::text('facebook', $user->fellowData->facebook, ["class" => "form-control"])}}
...
<div class="row">
  <div class="col-sm-6">
    <p>
      ...
      {{Form::text('linkedin', $user->fellowData->linkedin, ["class" => "form-control"])}}
  ...
  <div class="col-sm-6">
    <p>
      ...
      {{Form::text('other', $user->fellowData->other, ["class" => "form-control"])}}
      @if($errors->has('other'))
...
<div class="row">
  <div class="col-sm-12">
    <p>
      <label><strong>Semblanza</strong> <br>
        {{Form::textarea('semblance',$user->fellowData->semblance, ["class" => "form-control"])}} </label>
  ...
  <p>{{Form::submit('Actualizar Perfil', ['class' => 'btn gde'])}}</p>
