{!! Form::open(['url' => url("dashboard/programas/save"), "class" => "form-horizontal"]) !!}
<div class="divider"></div>
<div class="row">
  <div class="col-sm-12">
    <h2 class="sa_title">Información del Programa</h2>
  </div>
</div>
<!-- title -->
<div class="row">
...
<div class="row">
  <div class="col-sm-12">
    <p>
      <label><strong>Pertenece a la convocatoria</strong></label>
      {{Form::select('notice_id',$notices,0, ['class' => 'form-control'])}}
      @if($errors->has('notice_id'))
      <strong class="danger">{{$errors->first('notice_id')}}</strong>
      @endif
    </p>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-12">
    <p>{{Form::submit('Guardar programa', ['class' => 'btn gde'])}}</p>
  </div>
</div>
{!! Form::close() !!}
