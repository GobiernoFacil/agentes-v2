...
<nav class="cd-stretchy-nav">
	...
	<ul>
		...
		<li><a href="{{url('programa-gobierno-abierto/programa-2018/ver-contenido')}}" class="btn_contenido {{ $__env->yieldContent('body_class') == 'program_content' ? 'active' : ''}}"><span>Contenido Programa 2018</span></a></li>
