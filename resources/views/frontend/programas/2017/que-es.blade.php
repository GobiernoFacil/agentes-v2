...
@section('title', 'Programa de Formación de Agentes Locales de Cambio en Gobierno Abierto y Desarrollo Sostenible 2017')
@section('description', 'Programa de Formación de Agentes Locales de Cambio en Gobierno Abierto y Desarrollo Sostenible 2017')
@section('body_class', 'programa 2017')
@section('canonical', url('programa-gobierno-abierto/2017'))
@section('breadcrumb', 'layouts.frontend.breadcrumb.bread_programa')

@section('content')
<div class="row">
	<div class="col-sm-10 col-sm-offset-1">
		<h1>Edición 2017 - PROGRAMA DE FORMACIÓN DE <strong>AGENTES LOCALES DE CAMBIO</strong> EN <strong>GOBIERNO ABIERTO</strong> Y DESARROLLO SOSTENIBLE<a href="#nota"><sup>1</sup></a></h1>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<table class="table">
											...
											<tr><td>1.2 Introducción al Gobierno Abierto, Desarrollo Sostenible y Proyectos Sociales</td>
											<td>En línea</td></tr>
										</table>
									</td>
								...
								<tr>
									...
									<td>
										<table class="table">
											<tr>
												<td>2.1 Repaso y discusión sobre aspectos fundamentales del Gobierno Abierto, Desarrollo Sostenible y Proyectos Sociales</td>
												<td>Presencial</td>
											</tr>
											<tr>
												<td>2.2 Identificación de Problemáticas Sociales y Alternativas de Solución mediante el Gobierno Abierto</td>
												<td>Presencial</td>
											</tr>
											<tr>
												<td>2.3 Taller de desarrollo de proyectos</td>
												<td>Presencial</td>
											</tr>
											<tr>
												<td>2.4 Puesta en Común de Diagnóstico Parte 1</td>
												<td>Presencial</td>
											</tr>
											<tr>
								...
								<!-- curso 1-->
								<tr>
									<td><h4>3. CURSO 1 <br>“Gobierno Abierto y los Objetivos del Desarrollo Sostenible”</h4></td>
									<td>
										<table class="table">
											<tr>
												<td>3.1 El papel de los ejes del Gobierno Abierto en la atención de la corrupción</td>
												<td>En línea</td>
											</tr>
											<tr>
												<td>3.2 Panorama internacional y el papel de los ODS en el Gobierno Abierto</td>
												<td>En línea</td>
											</tr>
											<tr>
								...
								<!-- curso 2-->
								<tr>
									<td><h4>4. CURSO 2 <br>"Herramientas para la Acción"</h4></td>
									<td>
										<table class="table">
											<tr>
												<td>4.1 Mejores prácticas y estrategias innovadoras de gobierno abierto </td>
												<td>En línea</td>
											</tr>
											<tr>
												<td>4.2 Mejores prácticas en la ejecución de políticas</td>
												<td>En línea</td>
											</tr>
											<tr>
												<td>4.3 Incidencia en políticas públicas y construcción de agendas </td>
												<td>En línea</td>
											</tr>
											<tr>
												<td>4.4 Medios de comunicación, información y opinión pública</td>
												<td>En línea</td>
											</tr>
											<tr>
												<td>4.5 Cierre y evaluación</td>
												<td>En línea</td>
											</tr>
										</table>
									</td>
								...
								<tr>
									...
									<td>
										<table class="table">
											<tr>
												<td>5.1 Diseño de proyectos sociales II - Construcción de la agenda de incidencia en política pública </td>
												<td>Presencial</td>
											</tr>
											<tr>
												<td>5.2 Cierre y evaluación</td>
												<td>En línea</td>
											</tr>
										</table>
									</td>
								...
								<!-- curso 3-->
								<tr>
									<td><h4>6. CURSO 3 <br>"Ya tengo mi agenda, ahora qué sigue..."</h4></td>
									<td>
										<table class="table">
											<tr>
												<td>6.1 Manejo de la comunicación con medios y con grupos de interés </td>
												<td>En línea</td>
											</tr>
											<tr>
												<td>6.2 Consideraciones presupuestales gubernamentales y fondeo público-privado de proyectos y alianzas</td>
												<td>En línea</td>
											</tr>
											<tr>
												<td>6.3 Monitoreo, Vigilancia y Evaluación de políticas públicas en Gobierno Abierto</td>
												<td>En línea</td>
											</tr>
											<tr>
												<td>6.4 Cierre y evaluación</td>
												<td>En línea</td>
											</tr>
										</table>
									</td>
								...
								<tr>
									...
									<td>
										<table class="table">
											<tr>
												<td>7.1 Seguimiento post curso mediante mentorías </td>
												<td>En línea</td>
											</tr>
											<tr>
