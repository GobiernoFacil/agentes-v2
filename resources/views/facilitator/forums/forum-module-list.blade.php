...
@if($general)
	...
	<div class="col-sm-3 right">
		<p>
			<a href='{{ url("tablero-facilitador/foros/ver-foro/$general->id") }}' class="btn xs view">Ver foro</a>
		</p>
	</div>
...
@endif
	...
	<div class="col-sm-3 right">
		<p>
			...
			<a href='{{ url("tablero-facilitador/foros/ver-foros/actividades/$module->id") }}' class="btn xs view">Ver módulo</a>
		</p>
	</div>
