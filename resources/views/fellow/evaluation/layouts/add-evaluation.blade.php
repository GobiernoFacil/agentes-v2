            ...
            <ul style="display: none;" id="GF-PNUD-quiz-correct-answers" >
		        ...
		        <div class="row">
			        <div class="col-sm-2 col-sm-offset-10">
						          ...
						          <p style="display: none;" id="GF-PNUD-quiz-end-btn"><a class="btn view block sessions_l" href="{{url("tablero/{$activity->session->module->program->slug}/evaluacion/{$activity->slug}/finalizar")}}">Finalizar</a></p>
		        	</div>
		        </div>
		      </div>
		    </div>
