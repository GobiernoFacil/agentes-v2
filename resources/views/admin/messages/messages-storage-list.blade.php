...
<div class="row">
  ...
  <div class="col-sm-3 center">
		<a href="{{ url('dashboard/mensajes/programa/'.$program->id.'/ver-mensajes') }}" class="btn gde"> Mensajes</a>
	</div>
</div>
...
<div class="row">
  <div class="col-sm-12">
	  <div class="box center">
	  	...
	  	<a href="{{ url('dashboard/mensajes/programa/'.$program->id.'/ver-mensajes') }}" class="btn ev"> Ir a Mensajes</a>
	  </div>
  </div>
</div>
@endif
