...
<div class="row">
	<div class="col-sm-9">
		<h1>Lista de Aspirantes verificados ({{$list_validated_count}})</h1>
	</div>
	<?php /*
	<div class="col-sm-3">
...
<div class="row">
	<div class="col-sm-4">
		<a class ="btn download gde" href ="{{url('dashboard/aspirantes/verificados')}}">Aspirantes con archivos verificados ({{$list_validated_count}})</a>
	</div>
	<div class="col-sm-4">
		<?php $z = 89;?>
