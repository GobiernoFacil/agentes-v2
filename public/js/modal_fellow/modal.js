			...
			$(function() {
				...
				var config = [
					{
						...
						"color"		: "white",
						"position"	: "LT",
						"text"		: "Este enlace te lleva al sitio de público del programa",
						"time" 		: 5000
					},
					{
						"name" 		: "tour_2",
						"bgcolor"	: "#53B5E3",
						"color"		: "white",
						"text"		: "<strong>Programa de Formación</strong> <br> En esta sección encontrarás los contenidos del programa así como las actividades a realizar.",
						"position"	: "LT",
						"time" 		: 5000
					},
					{
						...
						"bgcolor"	: "#53B5E3",
						"color"		: "white",
						"text"		: "<strong>Foros del programa</strong> <br>Participa en la discusión.",
						"position"	: "LT",
						"time" 		: 5000
					},
					{
						...
						"bgcolor"	: "#53B5E3",
						"color"		: "white",
						"text"		: "<strong>Mensajes</strong> <br>Envía y recibe mensajes de fellows y facilitadores.",
						"position"	: "LT",
						"time" 		: 5000
					},
					{
						...
						"bgcolor"	: "#53B5E3",
						"color"		: "white",
						"text"		: "<strong>Calificaciones</strong> <br>Consulta tus calificaciones en el programa.",
						"position"	: "LT",
						"time" 		: 5000
					},
					{
						...
						"bgcolor"	: "#53B5E3",
						"color"		: "white",
						"text"		: "<strong>Archivos</strong> <br>En esta sección encontrarás todos los archivos que subas a la plataforma.",
						"position"	: "LT",
						"time" 		: 5000
					},
					{
						...
						"bgcolor"	: "#53B5E3",
						"color"		: "white",
						"text"		: "<strong>Avisos</strong> <br>Consulta los últimos avisos y noticias del programa.",
						"position"	: "LT",
						"time" 		: 5000
					},
					{
						...
						"bgcolor"	: "#53B5E3",
						"color"		: "white",
						"text"		: "<strong>Acerca del Programa</strong> <br>Información relacionada al programa.",
						"position"	: "TL",
						"time" 		: 5000
					},
					{
						...
						"bgcolor"	: "#53B5E3",
						"color"		: "white",
						"text"		: "<strong>Contenido del programa</strong>.",
						"position"	: "TL",
						"time" 		: 5000
					},
					{
						...
						"bgcolor"	: "#53B5E3",
						"color"		: "white",
						"text"		: "<strong>Cómo funciona</strong> <br>Información acerca de cómo funciona el programa.",
						"position"	: "TL",
						"time" 		: 5000
					},
					{
						...
						"bgcolor"	: "#53B5E3",
						"color"		: "white",
						"text"		: "<strong>Comenzar Programa</strong>",
						"position"	: "TR",
						"time" 		: 5000
					},
					{
						...
						"bgcolor"	: "#53B5E3",
						"color"		: "white",
						"text"		: "<strong>Tu perfil</strong> <br>Aquí puedes editar tu información y agregar tu foto de perfil.",
						"position"	: "TR",
						"time" 		: 5000
					}
				...
				function showControls(){
					...
					$tourcontrols += '<h4>Bienvenido al Programa de Formación de Agentes Locales de Cambio en Gobierno Abierto y Desarrollo Sostenible.</h4>';
					$tourcontrols += '<p>Revisa rápidamente las principales funciones de la plataforma.</p>';
					$tourcontrols += '<span class="button" id="activatetour">Iniciar tour</span>';
						if(!autoplay){
