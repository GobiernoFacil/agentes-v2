...
<div class="row">
	...
	<div class="col-sm-3 right">
		<p>Promedio general: <span class="score_a block">{{$fellow->total_average($program->id) ? number_format($fellow->total_average($program->id)->average,2) : 'Sin promedio'}}</span></p>
	</div>
</div>
<div class="box score">
  <div class="row">
