...
<div class="row">
	<div class="col-sm-10 col-sm-offset-1">
		<h1><strong>Nuevo Léon</strong>, ejercicio local de gobierno abierto</h1>
		...
		<ul>
			...
			<li>
				<h3>3 representantes del Gobierno</h3>
				<ol>
					<li>Coordinación Ejecutiva de la Administración Pública del estado de Nuevo León</li>
					<li>Tribunal Superior de Justicia del estado de Nuevo León 						</li>
					<li>Congreso del estado de Nuevo León 											</li>
		...
		<!---contexto-->
		<h2>Contexto</h2>
		<p>El 20 de junio de 2016, el estado de Nuevo León se integró formalmente a los Ejercicios Locales de Gobierno Abierto a través de la firma de la <a href="http://inicio.inai.org.mx/SiteCollectionDocuments/Transparencia/Nuevo%20Le%C3%B3n/Nuevo%20Le%C3%B3n.pdf">Declaración Conjunta para la Implementación de las Acciones para un Gobierno Abierto</a>.</p>
		<p>En esta Declaración, firmada por tres representantes del Gobierno del Estado, dos representantes de la sociedad civil y el Organismo Garante de Acceso a la Información, Nuevo León se comprometió a impulsar esquemas de apertura gubernamental e instituir Secretariados Técnicos Tripartitas como mecanismos responsables de coordinar, incorporar y orientar los intereses de los actores que participen en los ejercicios de Gobierno Abierto Local.</p>
