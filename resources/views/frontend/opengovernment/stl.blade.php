...
<div class="row">
	...
	<div class="col-sm-8 col-sm-offset-2">
		<ol>
			<li><h2><a href="{{ url('archivos/kits-gobierno-abierto/KIT-00_Presentacion_Toolkits_de_Gobierno_Abierto_y_Desarrollo_Sostenible.pdf') }}">Presentación de la caja de herramientas para el Gobierno Abierto y el Desarrollo Sostenible</a> </h2>
			...
			<li><h2><a href="{{ url('archivos/kits-gobierno-abierto/KIT-02_PNUD-ST_Promover_la_pluralidad_y_la_participacion.pdf') }}">Kit 2. Promover la pluralidad y la participación de la sociedad civil</a> </h2>
...
fundamentales sobre la participación pública y se señalan algunas de las habilidades necesarias para impulsarla. De igual modo, se presentan algunas herramientas específicas que pueden ser de ayuda para generar procesos participativos y con ello hacer más sólido el núcleo de sociedad civil.</p>
			...
			<li><h2><a href="{{ url('archivos/kits-gobierno-abierto/KIT-03_PNUD-ST_Trabajar_en_espacios_multiactor.pdf') }}">Kit 3. Trabajar en espacios multiactor insertos en contextos inestables</a> </h2>
			...
			<li><h2><a href="{{ url('archivos/kits-gobierno-abierto/KIT-04_PNUD-ST_Elaborar_un_plan_estrategico.pdf') }}">Kit 4. Elaborar un plan estratégico e implementación de mecanismos de gestión</a> </h2>
			...
			<li><h2><a href="{{ url('archivos/kits-gobierno-abierto/KIT-05_PNUD-ST_Definir_compromisos_de_manera_participativa.pdf') }}">Kit 5. Definir compromisos de manera participativa</a> </h2>
...
busca proporcionar las bases para que las propuestas hechas por el STL sean construidas bajo los principios del Gobierno Abierto, principalmente, el de la participación, y en términos amplios, bajo criterios democráticos.</p>
			...
			<li><h2><a href="{{ url('archivos/kits-gobierno-abierto/KIT-06_PNUD-ST_Construir_compromisos_de_Desarrollo_Sostenible.pdf') }}">Kit 6. Construir compromisos de Desarrollo Sostenible y propuestas efectivas de solución a problemas públicos</a> </h2>
			...
			<li><h2><a href="{{ url('archivos/kits-gobierno-abierto/KIT-07_PNUD-ST_Colocar_el_GA.pdf') }}">Kit 7. Colocar el Gobierno Abierto y los compromisos en la agenda de instituciones y funcionarios clave</a> </h2>
			...
			<li><h2><a href="{{ url('archivos/kits-gobierno-abierto/KIT-08_PNUD-ST_Implementacion_evaluacion_y_seguimiento_de_compromisos.pdf') }}">Kit 8. Implementación, seguimiento y evaluación de compromisos</a> </h2>
