...
<div class="row">
	...
	<div class="col-sm-2 col-sm-offset-1">
		<a href="{{url('dashboard/foros/programa/' . $program->id . '/ver-foros/actividades')}}" class="btn view block sessions_l">Ir a foros</a>
	</div>
	<div class="col-sm-12">
		<div class="divider bg"></div>
	</div>
...
@foreach ($forums as $forum)
			...
			<div class="row">
				...
				<div class="col-sm-2 col-sm-offset-1">
					<a href='{{ url("dashboard/foros/programa/$program->id/ver-foro/$forum->id") }}' class="btn view block sessions_l">Ir a foro</a>
				</div>
				<div class="col-sm-12">
					<div class="divider bg"></div>
				</div>
      ...
      <?php $done = true; ?>
			<div class="row">
				...
				<div class="col-sm-2 col-sm-offset-1">
					<a href="{{url('dashboard/foros/programa/' . $program->id . '/ver-foros/estados')}}" class="btn view block sessions_l">Ir a foro</a>
				</div>
				<div class="col-sm-12">
					<div class="divider bg"></div>
				</div>
