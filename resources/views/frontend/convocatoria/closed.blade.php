...
@section('title', 'Convocatoria Cerrada Programa de Formación de Agentes Locales de Cambio en Gobierno Abierto y Desarrollo Sostenible')
@section('description', 'Convocatoria cerrada Programa de Formación de Agentes Locales de Cambio en Gobierno Abierto y Desarrollo Sostenible')
@section('body_class', 'convocatoria closed')
@section('canonical', url('convocatoria/cerrada/'.$notice->slug) )
