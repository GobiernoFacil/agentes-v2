      ...
      <li>
        ...
        <div class="row">
          <div class="col-sm-11 col-sm-offset-1">
            ...
            <p><label>Sí {{Form::radio('answer_q1_1[0]','1', $evaluation->answer_q1_1== 1 ? true : false,['class' => 'form-control answer_q1_1'])}}</label>
              <label>No {{Form::radio('answer_q1_1[1]','0', ($evaluation->answer_q1_1 == 0 && $evaluation->answer_q1_1 != null) ? true : false,['class' => 'form-control answer_q1_1'])}}</label>
            </p>
            ...
            <p>
              ...
              <p>
                ...
                <label>No {{Form::radio('answer_q1_3[1]','0', ($evaluation->answer_q1_3 == 0 && $evaluation->answer_q1_3 != null) ? true : false,['class' => 'form-control answer_q1_3'])}}</p>
              ...
              <div class="row">
                <div class="col-sm-11 col-sm-offset-1">
                  ...
                  <p>
                    ...
                    <label>No {{Form::radio('answer_q2_1[1]','0', ($evaluation->answer_q2_1 == 0 && $evaluation->answer_q2_1 != null) ? true : false,['class' => 'form-control answer_q2_1'])}}</label>
                  </p>
                  ...
                  <p>
                    ...
                    <label>No {{Form::radio('answer_q2_2[1]','0', ($evaluation->answer_q2_2 == 0 && $evaluation->answer_q2_2 != null) ? true : false,['class' => 'form-control answer_q2_2'])}}</label>
                  </p>
              ...
              <li>
                ...
                <div class="row">
                  <div class="col-sm-11 col-sm-offset-1">
                    ...
                    <p>
                      <label>Sí {{Form::radio('answer_q3_2[0]','1', $evaluation->answer_q3_2== 1 ? true : false,['class' => 'form-control answer_q3_1'])}}</label>
                      <label>No {{Form::radio('answer_q3_2[1]','0', ($evaluation->answer_q3_2 == 0 && $evaluation->answer_q3_2 != null) ? true : false,['class' => 'form-control answer_q3_1'])}}</label>
                    </p>
                    ...
                    <p>
                      ...
                      <label>Sí {{Form::radio('answer_q3_3[0]','1', $evaluation->answer_q3_3== 1 ? true : false,['class' => 'form-control answer_q3_2'])}}</label>
                      <label>No {{Form::radio('answer_q3_3[1]','0', ($evaluation->answer_q3_3 == 0 && $evaluation->answer_q3_3 != null) ? true : false,['class' => 'form-control answer_q3_2'])}}</label>
                    ...
                    <p>
                      ...
                      <label>No {{Form::radio('answer_q3_4[1]','0', ($evaluation->answer_q3_4 == 0 && $evaluation->answer_q3_4 != null) ? true : false,['class' => 'form-control answer_q3_4'])}}</label>
                    </p>
