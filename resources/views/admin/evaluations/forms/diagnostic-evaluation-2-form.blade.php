    	...
    	<li>
			...
			<div class="row">
	        	<div class="col-sm-11 col-sm-offset-1">
					...
					<label>No {{Form::radio('answer_q4_1[1]','0', ($evaluation->answer_q4_1 == 0 && $evaluation->answer_q4_1 != null) ? true : false,['class' => 'form-control answer_q4_1'])}}</label></p>
					...
					<label>No {{Form::radio('answer_q4_2[1]','0', ($evaluation->answer_q4_2 == 0 && $evaluation->answer_q4_2 != null) ? true : false,['class' => 'form-control answer_q4_2'])}}</label></p>
        ...
        <li>
			...
			<div class="row">
	        	<div class="col-sm-11 col-sm-offset-1">
					...
					<label>No {{Form::radio('answer_q5_1[1]','0', ($evaluation->answer_q5_1 == 0 && $evaluation->answer_q5_1 != null) ? true : false,['class' => 'form-control answer_q5_1'])}}</label></p>
                    ...
                    <label>No {{Form::radio('answer_q5_2[1]','0', ($evaluation->answer_q5_2 == 0 && $evaluation->answer_q5_2 != null) ? true : false,['class' => 'form-control answer_q5_2'])}}</label></p>
                    ...
                    <label>No {{Form::radio('answer_q5_3[1]','0', ($evaluation->answer_q5_3 == 0 && $evaluation->answer_q5_3 != null) ? true : false,['class' => 'form-control answer_q5_3'])}}</label> </p>
